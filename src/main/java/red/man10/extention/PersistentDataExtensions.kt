...
inline fun <reified T : Any> PersistentDataContainer.set(plugin: Plugin, key: String, type: PersistentDataType<T, T>, value: T) {
...
inline fun <reified T : Any> ItemStack.setPersistentData(plugin: Plugin, key: String, type: PersistentDataType<T, T>, value: T) {
